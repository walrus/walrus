...
The network will be trained on \todo{2103} examples, with a further 120 kept back for validation.
...
\todo[inline]{Note how library and dataset constrained performance (IE wrong error/activation functions?)}
