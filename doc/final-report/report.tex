...
\begin{titlepage}
    ...
    \vfill
    %\includegraphics[scale=0.20]{college_crest}
    \vfill
    \LARGE 2017\\
    \vfill
...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.25]{arduino_flat}
...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.25]{arduino_placement_back}
...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.25]{arduino_placement_front}
...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.20]{pressups_first_solution}
...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.60]{pressups_second_solution}
