...
\todo[inline]{Link to spec which details where it will be (below) PICTURES}
...
There are four different programs to be run on the microcontroller, each with an accompanying program running on the phone or computer.
...
\todo[inline]{put some of these (testing) in project management?}
